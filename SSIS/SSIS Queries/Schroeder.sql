-- SchroederData file format.
set nocount on

TRUNCATE TABLE dbo.SchroederData
...
WHERE [dbo].[SchroederCustomerCodes](CustomerCode) = '1'
	AND RowStatus = 0
	AND CommercialOrderLineStatus != 'Cancelled'

--select * from #TempSchroeder1
-------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT Company,
	Division,
	ProducerCode,
...
INSERT INTO dbo.SchroederData
SELECT *
FROM #TempSchroeder4

--select * into dbo.SchroederData from #TempSchroeder4
DROP TABLE #TempSchroeder1

DROP TABLE #TempSchroeder2

DROP TABLE #TempSchroeder3

DROP TABLE #TempSchroeder4

--select ? = count(1)  from dbo.SchroederData
--------------------------------------------------------------------------------------------------------------------------------------------------------
set nocount off

SELECT *
FROM dbo.SchroederData
ORDER BY PRODUCER,
	[SAMPLE DATE]
