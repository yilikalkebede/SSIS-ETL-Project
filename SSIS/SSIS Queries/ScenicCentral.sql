...
WHERE [dbo].[ScenicCustomerCodes](CustomerCode) = '1'
	AND RowStatus = 0
	AND CommercialOrderLineStatus != 'Cancelled'
--select * from #TempScenic1
---------------------------------------------------------------------------------------------------------------------------------------------
SELECT Company,
	Division,
	ProducerCode,
...
--select * into dbo.ScenicData from #TempScenic4 -- Use this if the table is deleted. 
INSERT INTO dbo.ScenicData
SELECT *
FROM #TempScenic4

DROP TABLE #TempScenic1

DROP TABLE #TempScenic2

DROP TABLE #TempScenic3

DROP TABLE #TempScenic4

--select ?=count(1) from dbo.ScenicData
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT *
FROM dbo.ScenicData
